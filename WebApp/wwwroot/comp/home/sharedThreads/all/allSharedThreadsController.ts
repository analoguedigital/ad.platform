module App {
    ...
    interface IAllSharedThreadsControllerScope extends ng.IScope {
        filterValues: Models.IFilterValue[];
    }

    interface IAllSharedThreadsController {
        title: string;
        searchTerm: string;
    ...
    class AllSharedThreadsController implements IAllSharedThreadsController {
        title: string;
        searchTerm: string;
        surveys: Models.ISurvey[];
        surveysData: string[];
        ...
        constructor(
            private $scope: IAllSharedThreadsControllerScope,
    ...
    angular.module("app").controller("allSharedThreadsController", AllSharedThreadsController);
}