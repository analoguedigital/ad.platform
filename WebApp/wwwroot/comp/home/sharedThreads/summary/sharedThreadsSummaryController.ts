module App {
    ...
    interface ISharedThreadsSummaryController {
        title: string;
    ...
    class SharedThreadsSummaryController implements ISharedThreadsSummaryController {
        ...
        load() {
            ...
            this.formTemplateResource.getSharedThreads({ projectId: projectId }).$promise
                .then((templates) => {
    ...
    angular.module("app").controller("sharedThreadsSummaryController", SharedThreadsSummaryController);
}